...
def customLogger():
    ...
    fileHandler = logging.FileHandler('/home/vipulsai/PycharmProjects/pythonProject7/Logs/'+time.strftime("%d-%m-%y")+'.text', mode='a')  # create file handler to save the file
